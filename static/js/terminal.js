  ...
  if (arg != '') {
    switch (command) {
      case 'cd':
        if (arg == '/' || arg == '~' || arg == '..') current_pwd = '~';
          ...
          output = '-no sub-directory found named : ' + arg + ' in the present directory :' + current_pwd;
          if (current_pwd == '~') {
        ...
        break;
      case 'cat':
        if (fileShow(arg) == false) output = '-no file found named : ' + arg + ' in the present directory :' + current_pwd;
        break;
      case 'lang':
        ...
        break;
      case 'ls':
        output = '-command ls take no arguments' ;
        break;
      case 'pwd':
          output = '-command pwd take no arguments' ;
          break;
      case 'clear':
            output = '-command clear take no arguments' ;
            break;
      case 'exit':
          output = '-command exit take no arguments' ;
          break;
      case 'help':
          output = '-command help take no arguments' ;
          break;
      default:
    ...
    switch (command) {
      case 'help':
        ...
        break;
      case 'pwd':
        output = 'present directory : ' + current_pwd;
        break;
      case 'clear':
        $('#last_result').html('');
        output = "clean-cmd"
      ...
      case 'exit':
        ...
        break;
      case 'cd':
        output = '-command cd requires one argument DIRECTORY_PATH' ;
        break;
      case 'cat':
        output = '-command cat requires one argument FILENAME' ;
        break;
      case 'lang':
        output = '-command lang requires one arguments -RU or -EN' ;
        break;
      default:
        output = '-bash no command found : ' + command;
        break;
